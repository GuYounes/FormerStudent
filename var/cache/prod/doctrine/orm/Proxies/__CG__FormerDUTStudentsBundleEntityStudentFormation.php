 ...
 */
class StudentFormation extends \FormerDUTStudentsBundle\Entity\StudentFormation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FormerDUTStudentsBundle\\Entity\\StudentFormation' . "\0" . 'formation', '' . "\0" . 'FormerDUTStudentsBundle\\Entity\\StudentFormation' . "\0" . 'student', '' . "\0" . 'FormerDUTStudentsBundle\\Entity\\StudentFormation' . "\0" . 'id', '' . "\0" . 'FormerDUTStudentsBundle\\Entity\\StudentFormation' . "\0" . 'graduationYear'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StudentFormation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setFormation(\FormerDUTStudentsBundle\Entity\Formation $formation)
    {
     ...
     * {@inheritDoc}
     */
    public function setStudent(\FormerDUTStudentsBundle\Entity\Student $student)
    {
